...
import { injectTeleports, shoulPrerender } from './utils'
import config from './config'
import { renderHeadToString } from './render-head'
import { isCacheable, microCache } from './page-cache'
...
const resolve = (p: string) => path.resolve(projRoot, p)

const degradeToClientRender = (res: Response, isProd: boolean) => {
